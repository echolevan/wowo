...
class CreatePlugsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('plugs', function (Blueprint $table) {
            ...
            $table->integer('download_num')->comment('插件下载次数');
            $table->integer('like_num')->comment('插件点赞次数');
            $table->integer('collect_num')->comment('插件收藏次数');
