    ...
    methods: {
        ...
        get_orders: function get_orders() {
            ...
            axios.post('user/orders/collect/' + this.page + '/' + this.size).then(function (res) {
                _this.count = res.data.res.collect_plug.length;
                _this.orders = res.data.res.collect_plug;
            });
        }
    }
});
...
// module
exports.push([module.i, "\n.user_orders .list[data-v-12b37caa] {\n  min-height: 320px;\n}\n.user_orders .list li[data-v-12b37caa] {\n  padding: 5px 0;\n  width: 100%;\n  font-size: 14px;\n  border-bottom: 1px solid #f2f2f2;\n}\n.user_orders .list li span[data-v-12b37caa] {\n  float: right;\n  font-size: 14px;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_c('strong', [_vm._v(_vm._s(v.title))])])], 1)
  })) : _c('p', {
