            ...
            axios.get('download/plug/' + id).then(function (res) {
                if (res.data.sta === 0) {
                    ...
                    if (res.data.type === 1) {
                        ...
                        // 跳转 下载
                        window.location.href = _this4.data.info.content;
                    } else {
                        // 收费插件 跳转到支付页面
                    }
                    console.log(res);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("收藏： " + _vm._s(_vm.plug.collect_num))]) : _c('span', {
    on: {
      "click": function($event) {
        _vm.collect_this(_vm.plug.id)
      }
    }
  }, [_vm._v("已收藏： " + _vm._s(_vm.plug.collect_num))]), _vm._v(" "), (_vm.plug.like_plug.length === 0) ? _c('span', {
    on: {
      "click": function($event) {
