...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('Breadcrumb', {
  ...
  }, [_c('Breadcrumb-item', [_vm._v("主页")]), _vm._v(" "), _c('Breadcrumb-item', [_vm._v("分类管理")]), _vm._v(" "), _c('Breadcrumb-item', [_vm._v("用户列表")])], 1), _vm._v(" "), _c('div', {
    staticStyle: {
      "padding": "10px 0"
    }
  }, [_vm._v("\n        是否显示签名\n        "), _c('i-switch', {
    ...
    })])])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.tel))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.email))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.configCamp[v.camp]))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.wwb))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.plugs.length))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.created_at))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(v.login_at))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.configYesOrNo[v.status]))]), _vm._v(" "), _c('td', [_c('Tag', {
      attrs: {
        "type": "dot",
    ...
    }, [_vm._v(_vm._s(_vm.configIsLogin[v.status]))])], 1), _vm._v(" "), _c('td', [_c('Tag', {
      attrs: {
        "type": "dot",
    ...
    }, [_vm._v(_vm._s(_vm.configYesOrNo[v.is_admin]))])], 1), _vm._v(" "), _c('td', [_c('Button', {
      attrs: {
        "type": "ghost",
        "size": "small"
      }
